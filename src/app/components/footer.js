    ...
    return ( <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12  w-11/12 space-y-3 text-center md:text-start justify-center md:justify-start md:w-11/12 mx-auto">
            <div className="col-span-8">
                ...
                <div className="flex justify-between pe-4 bg-indigo-700 rounded-lg md:w-4/12">
                    <input placeholder="Write your email here..." className=" py-4  rounded-s-lg "/>
                    <button >Subscribe</button>
                </div>
                <p className="text-xs md:text-sm mt-4">By subscribing you agree to with our Privacy Policy and provide consent to receive updates from our this website</p>
            </div>
